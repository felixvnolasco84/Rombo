  ...
  return (
    ...
    <div className="border-white border-y-2 py-4 lg:py-8 xl:py-16">
      <AccordionItem className="m-auto border-none w-10/12 lg:w-2/3 xl:w-1/2" value={item.question}>
        <AccordionTrigger className="text-left text-lg lg:text-xl xl:text-2xl">{item.question}</AccordionTrigger>
        <AccordionContent className="mt-3 text-left text-sm lg:text-base xl:text-lg">
          {item.answer}
        </AccordionContent>
      </AccordionItem>
    </div>
