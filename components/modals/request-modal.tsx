...
import { CommnetsComponent } from "@/app/(portal)/portal/components/CommentsComponent";
import { BrandComponent } from "@/app/(portal)/portal/components/BrandComponent";

export const RequestModal = () => {
  const { user } = useUser();
  const request = useRequestModal((state) => state.request);
  const isOpen = useRequestModal((state) => state.isOpen);
  const onClose = useRequestModal((state) => state.onClose);
